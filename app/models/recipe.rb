class Recipe < ApplicationRecord
    ...
    def self.search(query, options={include_recipes: true})
        ...
        if options[:include_sources]
            ...
            where_clauses << "unaccent(sources.name) ILIKE unaccent(:query)"
        end
